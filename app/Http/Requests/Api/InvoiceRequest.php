...
//            'calculationratedate' => 'nullable|date_format:Y-m-d',
            ...
            'customer.dv' => ['nullable','numeric','digits:1',
                Rule::requiredIf(function() {
                    return isset($this->customer['type_document_identification_id']) 
                        && $this->customer['type_document_identification_id'] == 6;
                }),
                'dian_dv:'.$this->customer["identification_number"]
            ],
            ...
            'customer.country_name'         => 'nullable|string|max:100',
            'customer.municipality_name'    => 'nullable|string|max:150',
            'customer.state_name'           => 'nullable|string|max:150',
            ...
            'customer.type_liability_ids' => 'nullable|array|min:1',
            'customer.type_liability_ids.*' => 'integer|exists:type_liabilities,id',
...
//            'deliveryparty.dv' => 'nullable|required_with:delivery|numeric|digits:1|dian_dv:'.$this->deliveryparty["identification_number"],
            ...
            'tax_totals.*.percent' => 'nullable|required_unless:tax_totals.*.tax_id,10,2|numeric',
            ...
            'invoice_lines.*.tax_totals.*.percent' => 'nullable|required_unless:invoice_lines.*.tax_totals.*.tax_id,10,2|numeric',
