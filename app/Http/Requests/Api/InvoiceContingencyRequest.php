...
class InvoiceContingencyRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'AdditionalDocumentReferenceID' => 'required|string',
            'AdditionalDocumentReferenceDate' => 'required|date_format:Y-m-d',
...
//            'deliveryparty.dv' => 'nullable|numeric|digits:1|dian_dv:'.$this->deliveryparty["identification_number"],
